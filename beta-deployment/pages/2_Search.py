...
def main():
    ...
    guide = """Ask a query and Nuggt would provide you answers along with the relevant sources."""
    information = """This app was created with a single AI command:
    Find websites related to **:blue[{text\t:query}]** using {tool:google} and list the relevant sources.
    """
