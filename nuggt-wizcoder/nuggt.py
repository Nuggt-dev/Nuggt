...
def get_tool_info(tool_name):
    tools = {
        "python": {"type": "tool", "name": "python", "use": "Use this to execute python code. Display your results using the print function.", "input": "Input should be a valid python code. Ensure proper indentation", "function": tool.python},
...
def initialise_agent(nuggt, value_dict, tools):   
    ...
    while(True):
        ...
        output = generate(messages[0]["content"] + " <|end|>")
