...
if uploaded_file is not None:
    ...
    embeddings = OpenAIEmbeddings(openai_api_key="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")
    ...
    if query:
        with st.spinner("Fetching answer..."):
            llm = ChatOpenAI(temperature=0, model_name="gpt-4", openai_api_key="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")
